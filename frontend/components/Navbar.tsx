...
export default function () {
	return (
		<Flex as="header" position="fixed" top='0' 
			...
			>
			<Center>
				<Heading fontFamily='Comfortaa' fontSize='2xl' fontWeight="400" color="brand.white">
					<Box as="span" color="brand.orange" fontWeight='700'>X</Box>at<Box as="span" color="brand.orange" fontWeight='700'>N</Box>earby
				</Heading>
			</Center>
			<Spacer />
			<Box p='4'>
